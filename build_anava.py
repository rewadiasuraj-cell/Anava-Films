...
<section class="hero-cine">
  ...
  <div class="container hero-cine-inner">
    ...
    <p class="hero-cine-lead">
      <span class="hero-line hero-line-1">Anava Films is an <span class="nobr">agency-cum-production</span> house bringing ideas to life &mdash; from first thought to final frame.</span>
