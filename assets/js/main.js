...
window.projectsData = {
  ...
  'indus-valley-brand': {
    ...
    thumbVideo: 'assets/media/tvc/INDUS VALLEY FILM.mp4',
    videoSrc: 'assets/media/tvc/INDUS VALLEY FILM.mp4',
  ...
  'tira-beauty-kareena': {
    ...
    thumbVideo: 'assets/media/tvc/TIRA X KAREENA KAPOOR FILM.mp4',
    videoSrc: 'assets/media/tvc/TIRA X KAREENA KAPOOR FILM.mp4',
  ...
  'testimonial-lenskart-film': {
    id: 'testimonial-lenskart-film',
    title: 'Partner Testimonial Film',
  ...
  'testimonial-lenskart-1': {
    ...
    title: 'Partner Testimonial I',
    client: 'Lenskart Leadership',
    category: 'testimonials',
    subcategories: ['social'],
    format: 'Client Testimonial Film',
    roles: ['Interview Production', 'Direction', 'Editing'],
    thumbVideo: 'assets/media/testimonials/lenskart-testimonial-01.mp4',
    videoSrc: 'assets/media/testimonials/lenskart-testimonial-01.mp4',
  ...
  'testimonial-lenskart-2': {
    ...
    title: 'Leadership Testimonial I',
    client: 'Lenskart Leadership',
    category: 'testimonials',
    subcategories: ['social'],
    format: 'Client Testimonial Film',
    roles: ['Interview Production', 'Direction', 'Editing'],
    thumbVideo: 'assets/media/testimonials/lenskart-testimonial-02.mp4',
    videoSrc: 'assets/media/testimonials/lenskart-testimonial-02.mp4',
  ...
  'testimonial-lenskart-3': {
    id: 'testimonial-lenskart-3',
    title: 'Leadership Testimonial II',
    client: 'Lenskart Leadership',
    category: 'testimonials',
    subcategories: ['social'],
    format: 'Client Testimonial Film',
    roles: ['Interview Production', 'Direction', 'Editing'],
    thumbVideo: 'assets/media/testimonials/lenskart-testimonial-03.mp4',
    videoSrc: 'assets/media/testimonials/lenskart-testimonial-03.mp4',
    shortDesc: 'Lenskart leadership feedback on vision, strategy, and seamless execution.',
    thought: 'Translating vision into high-impact visual storytelling.',
    idea: 'Focused executive sit-down detailing Anava’s creative precision.',
    making: 'Cinema studio lighting with dedicated audio capture.'
  },
  'testimonial-lenskart-4': {
    id: 'testimonial-lenskart-4',
    title: 'Partner Testimonial II',
    client: 'Lenskart Leadership',
    category: 'testimonials',
    subcategories: ['social'],
    format: 'Client Testimonial Film',
    roles: ['Interview Production', 'Direction', 'Editing'],
    thumbVideo: 'assets/media/testimonials/lenskart-testimonial-04.mp4',
    videoSrc: 'assets/media/testimonials/lenskart-testimonial-04.mp4',
    shortDesc: 'Lenskart leadership on production impact and partnership depth.',
    thought: 'Building long-term strategic relationships with visionary brands.',
    idea: 'Authentic narrative focusing on reliability, quality, and speed.',
    making: 'Executive studio setup with two-angle interview capture.'
  },
  'testimonial-lenskart-5': {
    id: 'testimonial-lenskart-5',
    title: 'Leadership Testimonial III',
    client: 'Lenskart Leadership',
    category: 'testimonials',
    subcategories: ['social'],
    format: 'Client Testimonial Film',
    roles: ['Interview Production', 'Direction', 'Editing'],
    thumbVideo: 'assets/media/testimonials/lenskart-testimonial-05.mp4',
    videoSrc: 'assets/media/testimonials/lenskart-testimonial-05.mp4',
    shortDesc: 'Reflections on creative excellence and brand consistency.',
    thought: 'Maintaining high production value across multi-channel campaigns.',
    idea: 'Insightful client interview detailing Anava’s end-to-end execution.',
    making: 'Multi-cam studio interview with professional color grading.'
  },
  'wow-testimonial-2': {
