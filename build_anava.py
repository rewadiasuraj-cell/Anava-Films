...
<section class="hero-cine">
  ...
  <div class="container hero-cine-inner">
    ...
    <p class="hero-cine-lead">
      <span class="hero-line hero-line-1">Anava Films brings ideas to life from first thought to final frame, across creative, production and <span class="nobr">post-production</span>.</span>
    </p>
